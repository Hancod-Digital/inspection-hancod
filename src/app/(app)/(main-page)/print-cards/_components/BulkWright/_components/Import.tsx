...
export default function Import() {
  const { file, handleFileChange, duplicateHandling, handleValueChange } = useStepper()
      ...
      <Card className="p-8 border-dashed" onDrop={handleDrop} onDragOver={handleDragOver}>
        <div className="flex flex-col items-center justify-center text-center">
          ...
          {file ? (
            ...
            <p className="text-sm mb-2 text-muted-foreground ">File Selected: {file.name}</p>
          ) : (
            // Original content when no file is selected
            <>
