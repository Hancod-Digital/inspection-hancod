...
export default function EquipmentDetailsForm({ onClose, setChanged,changed }: EquipmentDetailsFormProps) {
  ...
  useEffect(() => {
    ...
    fetchAreas();
  }, [getAllSingleSubtopic,changed]); // Runs once on component mount
