...
export default function EquipmentDetailsForm({ onClose }: EquipmentDetailsFormProps) {
  ...
  const onSubmitHandler: SubmitHandler<EquipmentDetailsInput> = async(values) => {
    setLoading(true) 
    await addRecord(values,null,"equipment_type")
    setLoading(false) 
    onClose()
  };
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-4">
                  ...
                  <Button className="px-10  hover:bg-secondary hover:border hover:border-primary border hover:text-primary" type="submit" disabled={loading}>
                    {loading ? 'Saving...' : 'Save'}
                  </Button>
                </div>
              </div>
