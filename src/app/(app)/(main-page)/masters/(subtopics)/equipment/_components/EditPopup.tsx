  ...
  <CardContent>
    <FormProvider {...methods}>
      ...
      >
              ...
              <div className="grid gap-4 grid-cols-2">
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.minorCategory && (
                      <p className="text-red-500 text-[8px] mt-1 ">{errors.minorCategory.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.equipmentNo && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.equipmentNo.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.ownerIdTagNo && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.ownerIdTagNo.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.registrationNo && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.registrationNo.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.modelNo && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.modelNo.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div className="relative">
                    ...
                    {errors.supplierManufacturer && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.supplierManufacturer.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.testCertificateNo && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.testCertificateNo.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div className="relative">
                    ...
                    {errors.location && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.location.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.title && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.title.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.standard && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.standard.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.serialNo && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.serialNo.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.annexure && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.annexure.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.yearOfManufacture && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.yearOfManufacture.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.active && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.active.message}</p>
                    )}
                  </div>
                </div>
                </div>
          ...
          <CardContent> */}
           <CardHeader>
            <CardTitle className="text-lg   w-full ">Certificate Details</CardTitle>
          </CardHeader>
            <div className="space-y-4 ">
              <div className="grid gap-4 grid-cols-2">
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.safeWorkingLoad && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.safeWorkingLoad.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    />
                    {errors.lastTestDate && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.lastTestDate.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.proofLoad && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.proofLoad.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    />
                    {errors.nextTestDate && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.nextTestDate.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.testInspFrequency && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.testInspFrequency.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.testInspFrequencyMonths && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.testInspFrequencyMonths.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.lastThoroughDate && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.lastThoroughDate.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[200px_1fr] items-start gap-4">
                  ...
                  <div>
                    ...
                    {errors.nextThoroughDate && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.nextThoroughDate.message}</p>
                    )}
                  </div>
                </div>
                </div>
            ...
            <div className="space-y-4 ">
              <div className="grid gap-4 grid-cols-1">
                ...
                <Controller
                    ...
                    />
                    {errors.description && (
                      <p className="text-red-500 text-[8px] mt-1">{errors.description.message}</p>
                    )}
                </div>
              </div>
              </div>
