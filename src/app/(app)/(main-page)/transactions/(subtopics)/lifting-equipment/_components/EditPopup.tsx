...
export default function EditEquipmentDetailsForm({
  ...
  const methods = useForm<EquipmentDetailsInput>({
    ...
    defaultValues: {
      ...
      requestedByOwner: data?.requestedByOwner || '',
      ...
      testCertCOCNo: data?.testCertCOCNo || '',
      model: data?.model || '',
      ...
      lastThoroughDate: data?.lastThoroughDate || '',
      nextThoroughDate: data?.nextThoroughDate || '',
                  ...
                  <div className="grid grid-cols-[200px_1fr] gap-4">
                    ...
                    {errors.requestedByOwner && (
                      <p className="text-red-500 mt-1">
                        {errors.requestedByOwner.message}
                      </p>
                    )}
                  </div>
