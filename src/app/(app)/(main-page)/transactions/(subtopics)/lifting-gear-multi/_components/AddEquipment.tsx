...
export default function AddEquipment({ onClose, setIsLocation, setIsEquipment, setIsStandard, setIsManufacturer }: AddEquipmentProps) {
  ...
  const addEquipmentToMulti = async () => {
    ...
    const datas = {
      ...
      last_test_exam,
      last_thorough_exam: last_thorough_exam == null ? "Not Applicable" : last_thorough_exam,
      next_test_exam,
      next_thorough_exam: next_thorough_exam == null ? "Not Applicable" : next_thorough_exam,
