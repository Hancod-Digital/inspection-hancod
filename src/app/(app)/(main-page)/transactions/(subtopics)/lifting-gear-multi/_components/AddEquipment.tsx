              ...
              <div className="space-y-4 pt-10">
                ...
                <div className="grid gap-4 grid-cols-2">
                  ...
                  <div className="grid grid-cols-[200px_1fr] gap-4">
                    ...
                    <Input id="title" disabled={isAutoFill} {...register('title')} />
                    {errors.title && (
                ...
                <section className='grid gap-4 grid-cols-1'>
                  <div className="grid grid-cols-[200px_1fr] gap-4">
                    ...
                    <Input maxLength={119} id="equipment_description" disabled={isAutoFill} {...register('equipment_description')} />
                ...
                <div className="grid gap-4 grid-cols-2">
                  <div className="grid grid-cols-[200px_1fr] gap-4">
                    ...
                    <Input id="test_cert_coc_no" disabled={isAutoFill} {...register('test_cert_coc_no')} />
                  ...
                  <div className="grid grid-cols-[200px_1fr] gap-4">
                    ...
                    <Input disabled={isAutoFill} id="safe_working_load" {...register('safe_working_load')} />
                  ...
                  <div className="grid grid-cols-[200px_1fr] gap-4">
                    ...
                    <Input id="proof_load" disabled={isAutoFill} {...register('proof_load')} />
                    {errors.proof_load && (
