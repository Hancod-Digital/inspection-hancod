...
export const josapp:model = {
    name: "JosApp",
    client: "Edu Advisor", 
    industry: "Edtech", 
    bgColor:"josapp",
    listImage:"/portfolio/works/josapp/listImage.svg",
    listImageSm:"/portfolio/works/josapp/listImageSm.svg",
    description: "JosApp is an innovative educational consultancy app designed to bridge the gap between students seeking admission and institutions worldwide.",
     topImage: "/portfolio/works/josapp/top.svg",
    year:2024,
    challenge: "JosApp faces the intricate task of marrying diverse educational frameworks and varied user expectations into a cohesive, secure, and user-friendly platform. With an array of academic differentiators, languages, and educational systems, the challenge is to create a universally intuitive UI/UX while handling sensitive data and adhering to international privacy laws.",
    framework: "JosApp uses a strong, adaptable framework that adheres to worldwide data protection standards and has a flexible design capable of interacting with numerous institutional systems. The design draws on user feedback from a global audience to create an interface that is both culturally neutral and highly intuitive. Personalized algorithms, driven by safe data analytics, ensure that students receive tailored assistance, while multi-language support broadens accessibility, making the platform a superior educational consultation platform.",
    adSection: {
      heading: "Design Philosophy and Approach for JosApp",
      description1: "We focused on creating an intuitive, user-centric, and visually compelling interface for JosApp. We developed a modern, clean, and responsive design that adapts seamlessly across devices, based on thorough research of user needs.",
      description2: "Following an iterative design process with wireframing, prototyping, and extensive usability testing, we ensured a consistent design language, accessibility, and strong brand identity. Leveraging the latest UI/UX and graphic design tools, we delivered an innovative solution that exceeds client and user expectations.",
      imgUrl: "/portfolio/works/josapp/adSection.svg"
    },
    testimonials: {
      stars: 5,
      content: "I am immensely impressed by the College Admission app's exceptional quality and functionality. The Hancod team has done an outstanding job in creating a seamless and user-friendly platform that streamlines the entire college application process.",
      name: "Bimil Benny",
      role: "CEO, JosApp",
    },
    bottomImage: "/portfolio/works/josapp/bottom.svg",
    technologies: [{
      name: "Node.js",
    ...
    {
      name: "Supabase",
      image: "/technologies/supabase.svg"
    },
    {
      name: "Flutter",
  ...
  export const proutive:model = {
    name: "Proutive",
    client: "Hancod",
    industry: "Productivity",
    bgColor:"proutive",
    listImage:"/portfolio/works/proutive/listImage.svg",
    listImageSm:"/portfolio/works/proutive/listImageSm.svg",
    description: "Proutive is a powerful and intuitive to-do and habit tracker app designed to help you stay on top of your daily tasks and routines. With its user-friendly interface and robust features, Proutive makes it easy to set goals, track progress, and stay motivated.",
    topImage: "/portfolio/works/proutive/top.svg",
    year:2024,
    challenge: "Proutive wants to be the best app for organizing your daily life and helping you plan your day for better productivity and lifestyle. The challenge is to make the app easy to use and look great, while also letting users customize their routines to fit their needs. It's important that the app is simple enough for anyone to use but can still handle different users' wants.",
    framework: "To make Proutive a remarkable tool for everyday management, we'll prioritize a user-friendly design that's simple to access and personalize. Users will be able to quickly set up and customize their daily routines to meet their demands. In addition, we will bring special features such as AI-powered suggestions and wellness tracking to provide more than simply scheduling, making Proutive not only convenient but also truly useful in optimizing daily living. This strategy attempts to promote Proutive as a one-of-a-kind and indispensable tool for everyone trying to boost their productivity and lifestyle.",
    adSection: {
      heading: "",
      description1: "This project objective was to design a very user friendly Daily planner and habit tracker app, where users can easily split their day into small tasks and help users to Organise daily tasks, Set goals & Track Routine.",
      description2: "To achieve this, the app incorporates intuitive navigation and a clean interface, making it simple for users of all tech backgrounds to plan their day efficiently. Users can easily break down their day into manageable tasks, ensuring that nothing gets overlooked.",
      imgUrl: "/portfolio/works/proutive/adSection.svg"
    },
    blankTestimonial:"/portfolio/works/proutive/blankTestimonial.svg",
    bottomImage: "/portfolio/works/proutive/bottom.svg",
    technologies: [{
        name: "Node.js",
        image: "/technologies/node.svg"
      },
  ...
  export const duxbe:model = {
    name: "Duxbe",
    client: "Hancod",
    industry: "Productivity",
    bgColor:"duxbe",
    listImage:"/portfolio/works/duxbe/listImage.png",
    listImageSm:"/portfolio/works/duxbe/listImageSm.svg",
    description: "Duxbe is a user-friendly billing software developed by Hancod, offering unique features tailored to streamline the billing process. It stands out for its ease of use and comprehensive functionalities, catering to various business needs with efficiency and precision.",
    topImage: "/portfolio/works/duxbe/top.svg",
    year:2024,
    challenge: "To create a user-friendly billing app for small shops and business enterprises, the project faces the challenge of designing an intuitive yet comprehensive solution that caters to varied business needs and technical expertise levels. Adapting to diverse business models and maintaining a straightforward user interface is crucial, as is conducting thorough user testing with real business owners to refine the app’s usability and effectiveness in streamlining the invoicing process for small and medium-sized enterprises.",
    framework: "In our endeavor to create an exceptional billing app for small businesses and enterprises, our team focused on user-centric design, ensuring ease of use for all technical skill levels. This comprehensive billing solution boasts customizable invoice templates, automatic tax calculations, and multi-currency support, all within a secure, intuitive interface. We prioritized seamless integration with existing accounting and CRM systems, fortified by advanced security measures to protect financial data.",
    adSection: {
      heading: "Designing the Duxbe App",
      description1: "The Duxbe app features an intuitive, visually appealing interface with a consistent color scheme, readable typography, clear iconography, and a clean layout for seamless navigation and billing processes.",
      description2: "The app uses responsive design for various devices, ensuring touch-friendly interactions and optimized performance. Accessibility features like keyboard navigation, screen reader compatibility, and scalable text make Duxbe user-friendly for all.",
      imgUrl: "/portfolio/works/duxbe/adSection.svg"
    },
    blankTestimonial:"/portfolio/works/duxbe/blankTestimonial.svg",
    bottomImage: "/portfolio/works/duxbe/bottom.svg",
    technologies: [{
        name: "Node.js",
        image: "/technologies/node.svg"
      },
  ...
  export const portfolio = [josapp,proutive,duxbe]
  export const resources = [
    {
      type: 'webinar',
      title: 'From VMware to the future the ultimate cloud development infra',
      description: 'Gain another decade of stability with an open source cloud infrastructure',
      tags: ['vmware', 'openstack', 'microcloud', 'hybrid cloud', 'multicloud'],
    },
    {
      type: 'datasheet',
      title: 'Start your Data and AI journey with Canonical requires minimal effort',
      description: 'Explore the rich data and ML open source ecosystem with minimal effort',
      tags: ['Data', 'AI'],
    },
    {
      type: 'white paper',
      title: 'Migrating from RHEL-based distributions to Ubuntu in the public cloud',
      description: 'A strategy guide for administrators, with a cheat sheet and an example migration',
      tags: ['ubuntu', 'cloud-migration', 'centos', 'migration', 'public-cloud'],
    },
  ];